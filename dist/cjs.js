...
function getSchemaDump(connection, options, tables) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createStatements = (yield connection.multiQuery(getSchemaMultiQuery))
            ...
            if (isCreateView(res)) {
                return Object.assign(Object.assign({}, table), { name: res.View, schema: format(res['Create View']), data: null, isView: true });
            }
            return Object.assign(Object.assign({}, table), { name: res.Table, schema: format(res['Create Table']), data: null, isView: false });
        })
            .map(s => {
...
function buildInsert(table, values, format) {
    const sql = format([
...
class DB {
    ...
    static connect(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const instance = new DB(yield promise.createConnection(options));
            pool.push(instance);
            return instance;
        });
    }
...
function main(inputOptions) {
    ...
    try {
        ...
        const observer = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.dump.data !== false) {
                ...
                const tables = res.tables;
                res.tables = yield getDataDump(options.connection, options.dump.data, tables, options.dumpToFile, status);
